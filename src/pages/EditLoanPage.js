        ...
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row g-3 mb-4">
                    ...
                    <div className="col-md-6"> <label htmlFor="interestRate" className="form-label">Monthly Interest Rate (%)</label> <select id="interestRate" className="form-select" value={interestRate} onChange={e => setInterestRate(e.target.value)} required > <option value="1.0">1.0%</option> <option value="1.5">1.5%</option> <option value="2.0">2.0%</option> <option value="2.25">2.25%</option> <option value="2.5">2.5%</option> <option value="3.0">3.0%</option> <option value="3.5">3.5%</option> </select> </div>
